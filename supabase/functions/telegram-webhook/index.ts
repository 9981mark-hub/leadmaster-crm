...
중요: 메시지 내용에 고객명이 포함되어 있다면 "customerName" 필드로 추출하세요. (예: "박현승집 등기부...", "김종호체납은..." 등 띄어쓰기가 없어도 이름을 유추하세요). 고객명이 전혀 파악되지 않거나, 단순한 인사말("넵", "수고하셨습니다" 등)인 경우 customerName을 null로 응답하세요.
