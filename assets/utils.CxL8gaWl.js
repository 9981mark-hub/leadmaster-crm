 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ht="SILENT_ERROR";class je{constructor(e,n,o,s={}){this.model=n,this.params=o,this._requestOptions=s,this._history=[],this._sendPromise=Promise.resolve(),this._apiKey=e,o!=null&&o.history&&(Ue(o.history),this._history=o.history)}async getHistory(){return await this._sendPromise,this._history}async sendMessage(e,n={}){var o,s,i,a,r,c;await this._sendPromise;const f=N(e),m={safetySettings:(o=this.params)===null||o===void 0?void 0:o.safetySettings,generationConfig:(s=this.params)===null||s===void 0?void 0:s.generationConfig,tools:(i=this.params)===null||i===void 0?void 0:i.tools,toolConfig:(a=this.params)===null||a===void 0?void 0:a.toolConfig,systemInstruction:(r=this.params)===null||r===void 0?void 0:r.systemInstruction,cachedContent:(c=this.params)===null||c===void 0?void 0:c.cachedContent,contents:[...this._history,f]},p=Object.assign(Object.assign({},this._requestOptions),n);let l;return this._sendPromise=this._sendPromise.then(()=>vt(this._apiKey,this.model,m,p)).then(u=>{var g;if(ft(u.response)){this._history.push(f);const E=Object.assign({parts:[],role:"model"},(g=u.response.candidates)===null||g===void 0?void 0:g[0].content);this._history.push(E)}else{const E=C(u.response);E&&console.warn(`sendMessage() was unsuccessful. ${E}. Inspect response object for details.`)}l=u}).catch(u=>{throw this._sendPromise=Promise.resolve(),u}),await this._sendPromise,l}async sendMessageStream(e,n={}){var o,s,i,a,r,c;await this._sendPromise;const f=N(e),m={safetySettings:(o=this.params)===null||o===void 0?void 0:o.safetySettings,generationConfig:(s=this.params)===null||s===void 0?void 0:s.generationConfig,tools:(i=this.params)===null||i===void 0?void 0:i.tools,toolConfig:(a=this.params)===null||a===void 0?void 0:a.toolConfig,systemInstruction:(r=this.params)===null||r===void 0?void 0:r.systemInstruction,cachedContent:(c=this.params)===null||c===void 0?void 0:c.cachedContent,contents:[...this._history,f]},p=Object.assign(Object.assign({},this._requestOptions),n),l=_t(this._apiKey,this.model,m,p);return this._sendPromise=this._sendPromise.then(()=>l).catch(u=>{throw new Error(ht)}).then(u=>u.response).then(u=>{if(ft(u)){this._history.push(f);const g=Object.assign({},u.candidates[0].content);g.role||(g.role="model"),this._history.push(g)}else{const g=C(u);g&&console.warn(`sendMessageStream() was unsuccessful. ${g}. Inspect response object for details.`)}}).catch(u=>{u.message!==ht&&console.error(u)}),l}}/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Be{constructor(e){this.apiKey=e}getGenerativeModel(e,n){if(!e.model)throw new y("Must provide a model name. Example: genai.getGenerativeModel({ model: 'my-model-name' })");return new mt(this.apiKey,e,n)}getGenerativeModelFromCachedContent(e,n,o){if(!e.name)throw new _("Cached content must contain a `name` field.");if(!e.model)throw new _("Cached content must contain a `model` field.");const s=["model","systemInstruction"];for(const a of s)if(n!=null&&n[a]&&e[a]&&(n==null?void 0:n[a])!==e[a]){if(a==="model"){const r=n.model.startsWith("models/")?n.model.replace("models/",""):n.model,c=e.model.startsWith("models/")?e.model.replace("models/",""):e.model;if(r===c)continue}throw new _(`Different value for "${a}" specified in modelParams (${n[a]}) and cachedContent (${e[a]})`)}const i=Object.assign(Object.assign({},n),{model:e.model,tools:e.tools,toolConfig:e.toolConfig,systemInstruction:e.systemInstruction,cachedContent:e});return new mt(this.apiKey,i,o)}}const K=(t,e)=>{const o=e.filter(s=>s.active).filter(s=>{const i=t>=s.minFee,a=!s.maxFee||t<=s.maxFee;return i&&a});if(o.length!==0)return o.sort((s,i)=>i.minFee!==s.minFee?i.minFee-s.minFee:i.priority!==s.priority?i.priority-s.priority:i.updatedAt!==s.updatedAt?i.updatedAt.localeCompare(s.updatedAt):i.ruleId.localeCompare(s.ruleId)),o[0]},wt=(t,e)=>{if(!t)return 0;const n=K(t,e);return n?n.commission:0},It=(t,e,n)=>{if(!t.contractFee)return{payable:0,total:0,isPartial:!1};const o=K(t.contractFee,e);if(!o)return{payable:0,total:0,isPartial:!1};const s=(t.deposit1Amount||0)+(t.deposit2Amount||0),i=o.fullPayoutThreshold||0,a=n?n.downPaymentPercentage/100:.1,r=n?n.firstPayoutPercentage/100:.5;return i>0&&s>=i?{payable:o.commission,total:o.commission,isPartial:!1,rule:o}:s>=t.contractFee*a?{payable:o.commission*r,total:o.commission,isPartial:!0,rule:o}:{payable:0,total:o.commission,isPartial:!1,rule:o}},We=(t,e)=>{const n=[];return Nt.includes(t.status)&&(!t.reminders||t.reminders.length===0)&&n.push("리마인더 없음"),G.includes(t.status)&&!t.contractAt&&n.push("계약일 미입력"),G.includes(t.status)&&!t.contractFee&&n.push("수임료 미입력"),t.contractFee&&G.includes(t.status)&&e&&wt(t.contractFee,e.commissionRules)===0&&n.push("수당 룰 없음"),n},qe=t=>{const e=t.replace(/[^\d]/g,"");return e.length===2?parseInt(e,10)<=30?`20${e}`:`19${e}`:e},U=t=>t?String(t).replace(/[^0-9]/g,""):"",Ve=(t,e)=>{if(!t)return;const n=U(t);if(!(n.length<9))return e.find(o=>o.phone&&U(o.phone)===n)},h=t=>{if(t==null||isNaN(t))return"";if(t===0)return"0원";const e=Math.floor(t/1e4),n=t%1e4;return e>0&&n>0?`${e.toLocaleString()}억 ${n.toLocaleString()}만원`:e>0&&n===0?`${e.toLocaleString()}억원`:e===0&&n>0?`${n.toLocaleString()}만원`:"0원"},ze=(t,e=Dt)=>{var B,W,q;let n=e;t.maritalStatus==="미혼"&&(n=n.replace(/^\* 미성년 자녀 수 : .*\r?\n?/gm,"")),t.creditCardUse==="미사용"&&(n=n.replace(/^\* 신용카드 사용금액 : .*\r?\n?/gm,"")),t.jobTypes&&t.jobTypes.length===1&&t.jobTypes[0]==="무직"&&(n=n.replace(/^\* 4대보험 가입유무 : .*\r?\n?/gm,""));const o=[];t.housingType==="자가"?(t.ownHousePrice&&o.push(`집 시세 ${h(t.ownHousePrice)}`),t.ownHouseLoan&&o.push(`(집 담보대출 ${h(t.ownHouseLoan)})`),t.ownHouseOwner&&o.push(`[명의: ${t.ownHouseOwner}]`)):t.housingType==="무상거주"?(o.push("무상거주"),t.freeHousingOwner&&o.push(`[명의: ${t.freeHousingOwner}]`)):(t.deposit&&o.push(`보증금 ${h(t.deposit)}`),t.rent&&o.push(`월세 ${h(t.rent)}`),t.depositLoanAmount&&o.push(`(보증금 대출: ${h(t.depositLoanAmount)})`),t.rentContractor&&o.push(`[계약자: ${t.rentContractor}]`));const s=o.length>0?o.join(" "):"정보 없음",i=t.assets&&t.assets.length>0?t.assets.map(d=>{const R=d.desc?`(${d.desc})`:"",St=d.rentDeposit?`/전세${h(d.rentDeposit)}`:"";return`(${d.owner}/${d.type}${R} 시세 ${h(d.amount)}${d.loanAmount?`/담보${h(d.loanAmount)}`:""}${St})`}):[];let a=i.length>0?i.join(" "):"없음";const r=[];let c=0;t.housingType!=="자가"&&t.housingType!=="무상거주"&&t.depositLoanAmount&&(r.push(`보증금 대출(${h(t.depositLoanAmount)})`),c+=t.depositLoanAmount),t.housingType==="자가"&&t.ownHouseLoan&&(r.push(`집 담보 대출(${h(t.ownHouseLoan)})`),c+=t.ownHouseLoan),t.assets&&t.assets.filter(d=>d.loanAmount>0).forEach(d=>{r.push(`${d.type} 담보(${h(d.loanAmount)})`),c+=d.loanAmount}),t.collateralLoanMemo&&r.push(t.collateralLoanMemo);let f=r.length>0?r.join(", "):"없음";c>0&&(f+=` [총 합계: ${h(c)}]`);let m=0;const p=t.creditLoan&&t.creditLoan.length>0?t.creditLoan.map(d=>(m+=d.amount||0,`${d.desc} ${h(d.amount)}`)):[];t.creditCardUse==="사용"&&t.creditCardAmount&&(m+=t.creditCardAmount,p.push(`신용카드 ${h(t.creditCardAmount)}`));let l=p.length>0?p.join(", "):"없음";m>0&&(l+=` [총 합계: ${h(m)}]`);let u=t.historyType||"없음";t.historyType&&t.historyType!=="없음"&&t.historyMemo&&(u+=` (${t.historyMemo})`);const g=t.specialMemo?[...t.specialMemo].filter(d=>!d.content.startsWith("[상태변경]")).sort((d,R)=>R.createdAt.localeCompare(d.createdAt)):[],E=g.length>0?g.map(d=>`[${P(new Date(d.createdAt),"yyyy-MM-dd HH:mm",{locale:ge})}]
${d.content}`).join(`

`):"없음",M=t.jobTypes&&t.jobTypes.length>0?t.jobTypes.join(", "):"정보 없음",w=[];(B=t.incomeDetails)!=null&&B.salary&&w.push(`직장인 ${h(t.incomeDetails.salary)}`),(W=t.incomeDetails)!=null&&W.business&&w.push(`사업자 ${h(t.incomeDetails.business)}`),(q=t.incomeDetails)!=null&&q.freelance&&w.push(`프리랜서 ${h(t.incomeDetails.freelance)}`);let x=w.join(" + ");w.length>1?x+=` (총 ${h(t.incomeNet)})`:w.length===0&&(x=h(t.incomeNet));const Y={managerName:t.managerName,customerName:t.customerName,phone:t.phone,birth:t.birth?t.birth+"년생":"-",gender:t.gender,region:t.region,jobTypes:M,insurance4:t.insurance4,maritalStatus:t.maritalStatus,childrenCount:t.childrenCount!==void 0?t.childrenCount+"명":"-",incomeDetails:x,loanMonthlyPay:h(t.loanMonthlyPay),housingType:t.housingType,housingDetail:t.housingDetail,depositRentStr:s,assetsStr:a,creditLoanStr:l,collateralStr:f,creditCardUse:t.creditCardUse||"미사용",creditCardAmountStr:t.creditCardUse==="사용"&&t.creditCardAmount?h(t.creditCardAmount):"없음",historyStr:u,specialMemo:E};let F=n;for(const d in Y){const R=new RegExp(`{{${d}}}`,"g");F=F.replace(R,Y[d]||"")}return F.trim()},Rt=t=>{if(!t)return null;const e=Mt(t,"yyyy-MM-dd HH:mm",new Date);return v(e)?e:null},Xe=t=>{if(!t)return"none";const e=Rt(t);return e?yt(e)?"today":Ht(e)?"overdue":"future":"none"},Je=t=>{if(t==null)return null;if(t instanceof Date)return v(t)?t:null;const e=String(t);if(!e)return null;const n=new Date(e);if(v(n)&&e.includes("-")&&!isNaN(n.getTime()))return n;const o=e.trim(),s=/(\d{4})[\.\-]\s*(\d{1,2})[\.\-]\s*(\d{1,2})[\.]?\s*(오전|오후)?\s*(\d{1,2}):(\d{1,2})(?::(\d{1,2}))?/,i=o.match(s);if(i){const f=parseInt(i[1]),m=parseInt(i[2])-1,p=parseInt(i[3]),l=i[4];let u=parseInt(i[5]);const g=parseInt(i[6]),E=i[7]?parseInt(i[7]):0;l==="오후"&&u<12&&(u+=12),l==="오전"&&u===12&&(u=0);const M=new Date(f,m,p,u,g,E);if(v(M))return M}const a=/(\d{4})[\.\-]\s*(\d{1,2})[\.\-]\s*(\d{1,2})/,r=o.match(a);if(r){const f=parseInt(r[1]),m=parseInt(r[2])-1,p=parseInt(r[3]),l=new Date(f,m,p);if(v(l))return l}const c=new Date(e.replace(/\./g,"-"));return v(c)&&!isNaN(c.getTime())?c:null},j=t=>["일","월","화","수","목","금","토"][t]||"",Qe=(t,e)=>{const n=e.commissionRules,o=e.settlementConfig,s=t.filter(m=>m.partnerId===e.partnerId&&["1차 입금완료","2차 입금완료","계약 완료"].includes(m.status)&&m.contractFee);let i=0,a=0;s.forEach(m=>{const p=(m.deposit1Amount||0)+(m.deposit2Amount||0);i+=p;const{payable:l}=It(m,n,o);a+=l});const r=new Date;let c=z(r,o.cutoffDay,{weekStartsOn:0});Ft(c,r)&&!yt(c)&&(c=Gt(r,o.cutoffDay));let f=z(c,o.payoutDay,{weekStartsOn:0});return o.payoutDay<=o.cutoffDay&&(f=X(f,1)),o.payoutWeekDelay>0&&(f=X(f,o.payoutWeekDelay)),{cutoffDate:P(c,"yyyy-MM-dd"),payoutDate:P(f,"yyyy-MM-dd"),currentTotalDeposit:i,expectedCommission:a,threshold:0,isEligible:a>0,cutoffDayName:j(o.cutoffDay),payoutDayName:j(o.payoutDay)}},Ot=t=>new Promise((e,n)=>{const o=new FileReader;o.readAsDataURL(t),o.onload=()=>{if(typeof o.result=="string"){const s=o.result.split(",")[1];e(s)}},o.onerror=s=>n(s)}),Ze=t=>{if(!t)return"";if(!t.includes("drive.google.com"))return t;let e="";const n=t.match(/\/file\/d\/([a-zA-Z0-9_-]+)/);if(n)e=n[1];else{const o=t.match(/[?&]id=([a-zA-Z0-9_-]+)/);o&&(e=o[1])}return e?`https://drive.google.com/uc?export=download&id=${e}`:t},tn=(t,e)=>{if(!t)return"";let n=t;const o=e.managerName||localStorage.getItem("managerName")||"담당자 미정",s=/^[*]?\s*담당자\s*:.*/m;return s.test(n)?n=n.replace(s,`* 담당자 : ${o}`):n=`* 담당자 : ${o}
`+n,n},en=(t,e,n="-")=>{if(!t)return n;try{const o=new Date(t);return v(o)?P(o,e):n}catch(o){return console.warn("Date formatting error:",o),n}},nn=t=>{const e=[];let n=0;return t.housingType!=="자가"&&t.housingType!=="무상거주"&&t.depositLoanAmount&&(e.push(`보증금 대출(${h(t.depositLoanAmount)})`),n+=t.depositLoanAmount),t.housingType==="자가"&&t.ownHouseLoan&&(e.push(`집 담보 대출(${h(t.ownHouseLoan)})`),n+=t.ownHouseLoan),t.assets&&t.assets.filter(o=>o.loanAmount>0).forEach(o=>{e.push(`${o.type} 담보(${h(o.loanAmount)})`),n+=o.loanAmount}),e.length===0?"없음":`${e.join(", ")} (총 ${h(n)})`},on=async(t,e)=>{const n=localStorage.getItem("lm_geminiApiKey"),o="AIzaSyAcY0S1fvge0FtV_GsmEo5u15vdsau4sBU",s=n||o;if(s.trim()===""){console.warn("Gemini API Key missing! Fallback to Mock.");const i=`오류 진단 정보:
...
[자동 생성 예시] 내용 없음`)},1e3)})}try{const i=new Be(s),a=localStorage.getItem("lm_geminiModel")||"gemini-2.0-flash",r=i.getGenerativeModel({model:a}),c=await Ot(t),f=e&&e.trim().length>0?e:Lt;return(await(await r.generateContent([f,{inlineData:{data:c,mimeType:t.type||"audio/mp3"}}])).response).text()}catch(i){console.error("Gemini AI Error:",i);let a=i instanceof Error?i.message:"알 수 없는 오류";if(a.includes("404")||a.includes("not found"))try{const c=await(await fetch(`https://generativelanguage.googleapis.com/v1beta/models?key=${s}`)).json();if(c.models){const f=c.models.map(m=>m.name.replace("models/","")).join(", ");a+=`

[진단 - 사용 가능한 모델 목록]
${f}`}}catch(r){a+=`

[진단] 모델 목록 조회 실패 (CORS/Network): ${r}`}return`[오류 발생] AI 분석 중 문제가 발생했습니다.
사유: ${a}`}},an=Object.freeze(Object.defineProperty({__proto__:null,calculateCommission:wt,calculateNextSettlement:Qe,calculatePayableCommission:It,checkIsDuplicate:Ve,convertToPlayableUrl:Ze,fileToBase64:Ot,formatKoreanMoney:h,generateAiSummary:on,generateSummary:ze,getAutoCollateralString:nn,getCaseWarnings:We,getDayName:j,getMatchingRule:K,getReminderStatus:Xe,injectSummaryMetadata:tn,normalizeBirthYear:qe,normalizePhone:U,parseGenericDate:Je,parseReminder:Rt,safeFormat:en},Symbol.toStringTag,{value:"Module"}));export{Be as G,Pt as a,We as b,Qe as c,Ve as d,Je as e,Ot as f,Xe as g,Ze as h,yt as i,nn as j,ze as k,tn as l,wt as m,qe as n,on as o,Rt as p,j as q,en as s,an as u};
