import{b as ft,a as ht,n as wt,b9 as Y,aH as b,bk as gt,bl as Nt,bm as x,bn as q,f as F,bo as I,a$ as Dt,bp as Mt,aT as bt}from"./index.Pp98WvHY.js";function V(t,e,n){return ft(t,e*7,n)}function Lt(t){return ht(t,Date.now())}function $t(t,e,n){const[s,o]=wt(n==null?void 0:n.in,t,e);return+Y(s)==+Y(o)}function xt(t,e){return b(t,e==null?void 0:e.in).getDay()}function Ft(t,e){return+b(t)<+b(e)}function Gt(t){return+b(t)<Date.now()}function mt(t,e){return $t(ht(t,t),Lt(t))}function Ht(t,e,n){let s=e-xt(t,n);return s<=0&&(s+=7),ft(t,s,n)}var J;(function(t){t.STRING="string",t.NUMBER="number",t.INTEGER="integer",t.BOOLEAN="boolean",t.ARRAY="array",t.OBJECT="object"})(J||(J={}));/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Et(t,e,n,s){const o=await D(e,R.STREAM_GENERATE_CONTENT,t,!0,JSON.stringify(n),s);return te(o)}async function Ct(t,e,n,s){const i=await(await D(e,R.GENERATE_CONTENT,t,!1,JSON.stringify(n),s)).json();return{response:U(i)}}/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
