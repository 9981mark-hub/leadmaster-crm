 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ht="SILENT_ERROR";class je{constructor(e,n,o,s={}){this.model=n,this.params=o,this._requestOptions=s,this._history=[],this._sendPromise=Promise.resolve(),this._apiKey=e,o!=null&&o.history&&(Ue(o.history),this._history=o.history)}async getHistory(){return await this._sendPromise,this._history}async sendMessage(e,n={}){var o,s,i,a,r,c;await this._sendPromise;const h=N(e),d={safetySettings:(o=this.params)===null||o===void 0?void 0:o.safetySettings,generationConfig:(s=this.params)===null||s===void 0?void 0:s.generationConfig,tools:(i=this.params)===null||i===void 0?void 0:i.tools,toolConfig:(a=this.params)===null||a===void 0?void 0:a.toolConfig,systemInstruction:(r=this.params)===null||r===void 0?void 0:r.systemInstruction,cachedContent:(c=this.params)===null||c===void 0?void 0:c.cachedContent,contents:[...this._history,h]},g=Object.assign(Object.assign({},this._requestOptions),n);let l;return this._sendPromise=this._sendPromise.then(()=>vt(this._apiKey,this.model,d,g)).then(u=>{var p;if(ft(u.response)){this._history.push(h);const E=Object.assign({parts:[],role:"model"},(p=u.response.candidates)===null||p===void 0?void 0:p[0].content);this._history.push(E)}else{const E=C(u.response);E&&console.warn(`sendMessage() was unsuccessful. ${E}. Inspect response object for details.`)}l=u}).catch(u=>{throw this._sendPromise=Promise.resolve(),u}),await this._sendPromise,l}async sendMessageStream(e,n={}){var o,s,i,a,r,c;await this._sendPromise;const h=N(e),d={safetySettings:(o=this.params)===null||o===void 0?void 0:o.safetySettings,generationConfig:(s=this.params)===null||s===void 0?void 0:s.generationConfig,tools:(i=this.params)===null||i===void 0?void 0:i.tools,toolConfig:(a=this.params)===null||a===void 0?void 0:a.toolConfig,systemInstruction:(r=this.params)===null||r===void 0?void 0:r.systemInstruction,cachedContent:(c=this.params)===null||c===void 0?void 0:c.cachedContent,contents:[...this._history,h]},g=Object.assign(Object.assign({},this._requestOptions),n),l=_t(this._apiKey,this.model,d,g);return this._sendPromise=this._sendPromise.then(()=>l).catch(u=>{throw new Error(ht)}).then(u=>u.response).then(u=>{if(ft(u)){this._history.push(h);const p=Object.assign({},u.candidates[0].content);p.role||(p.role="model"),this._history.push(p)}else{const p=C(u);p&&console.warn(`sendMessageStream() was unsuccessful. ${p}. Inspect response object for details.`)}}).catch(u=>{u.message!==ht&&console.error(u)}),l}}/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
[자동 생성 예시] 내용 없음`)},1e3)})}try{const a=new Be(i),r=localStorage.getItem("lm_geminiModel")||"gemini-2.0-flash",c=a.getGenerativeModel({model:r}),h=await Ot(t);let d=e&&e.trim().length>0?e:Lt;return n&&(d=`
[알려진 정보 (고객 정보)]
...
`+`
`+d),(await(await c.generateContent([d,{inlineData:{data:h,mimeType:t.type||"audio/mp3"}}])).response).text()}catch(a){console.error("Gemini AI Error:",a);let r=a instanceof Error?a.message:"알 수 없는 오류";if(r.includes("404")||r.includes("not found"))try{const h=await(await fetch(`https://generativelanguage.googleapis.com/v1beta/models?key=${i}`)).json();if(h.models){const d=h.models.map(g=>g.name.replace("models/","")).join(", ");r+=`
