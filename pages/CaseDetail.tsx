    ...
    return (
        <div className="max-w-4xl mx-auto space-y-4">
            ...
            <div className="bg-white p-6 rounded-b-xl shadow-sm border border-gray-100 border-t-0 min-h-[600px]">
                ...
                {activeTab === 'summary' && (
                    <div className="grid md:grid-cols-2 gap-4 h-full min-h-[400px]">
                        {/* LEFT: Basic Summary */}
                        <div className="bg-white p-4 rounded-xl border border-gray-200 shadow-sm flex flex-col h-full">
                            ...
                            <div className="flex-1 relative h-full">
                                {isManualSummaryEdit ? (
                                    <textarea
                                        className="w-full h-full p-4 border rounded-lg text-sm leading-relaxed resize-none focus:ring-2 focus:ring-blue-500 outline-none min-h-[200px] max-h-[400px] overflow-y-auto"
                                        value={manualSummary}
                                        onChange={e => setManualSummary(e.target.value)}
                                    />
                                ) : (
                                    <div className="w-full h-full p-4 bg-gray-50 rounded-lg text-sm whitespace-pre-wrap leading-relaxed border border-gray-100 overflow-y-auto min-h-[200px] max-h-[400px]">
                        ...
                        <div className="bg-purple-50 p-4 rounded-xl border border-purple-100 shadow-sm flex flex-col h-full">
                            ...
                            <div className="flex-1 relative h-full">
                                {aiSummaryText ? (
                                    aiSummaryEditMode ? (
                                        <textarea
                                            className="w-full h-full p-4 border border-purple-200 rounded-lg text-sm leading-relaxed resize-none focus:ring-2 focus:ring-purple-500 outline-none min-h-[200px] max-h-[400px] overflow-y-auto"
                                            value={aiSummaryText}
                                            onChange={e => setAiSummaryText(e.target.value)}
                                        />
                                    ) : (
                                        <div className="w-full h-full p-4 bg-white rounded-lg text-sm whitespace-pre-wrap leading-relaxed border border-purple-100 overflow-y-auto cursor-text hover:bg-purple-50/50 transition-colors min-h-[200px] max-h-[400px]"
